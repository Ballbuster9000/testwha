...
setInterval(async () => {
const statuses = [`ppg`, `jarry's mod`, "forza horizon", "garand theft auto fayf", "memes", "hot roblos"]
const types = ["STREAMING", "WATCHING", "PLAYING", "LISTENING"]
client.user.setPresence({
  status: "idle"
});
   client.user.setActivity(statuses[Math.floor(Math.random() * statuses.length)], { type: types[Math.floor(Math.random() * statuses.length)], url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ"})
}, 10000)
});
